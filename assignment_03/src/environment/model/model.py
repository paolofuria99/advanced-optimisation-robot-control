...
class Pendulum:
    ...
    * visuals: the list of all the 'visual' 3D objects to render the robot, each element of the list being
    ...
    def __init__(self, nbJoint=1, maxVel=8., maxTorque=2., timeStep=0.05, noise_stddev=0.0):
        ...
        self.DT = timeStep  # Time step length
        self.NDT = 1  # Number of Euler steps per integration (internal)
        self.Kf = .10  # Friction coefficient
        self.vmax = maxVel  # Max velocity (clipped if larger)
        self.umax = maxTorque  # Max torque   (clipped if larger)
