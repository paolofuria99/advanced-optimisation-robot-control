...
foot_step_0 = np.array([0.0, -0.085])  # initial footstep position in x-y
...
w_com = 100  # weight of center of mass task (ref trajectory)    - default: 5e-1     best: 100
if SQUAT:
    w_squat = 10  # weight of squat task
else:
    w_squat = 0  # weight of squat task
w_foot = 3  # weight of the foot motion task                    - default: 1e-1     best: 3
w_contact = 1e2  # weight of the foot in contact
w_posture = 6e-4  # weight of joint posture task                 - default: 2e-2     best: 6e-4
...
gain_vector = np.array(  # gain vector for postural task
    [
        ...
        1.,
        1.,
        10.,  # left leg, low gain on axis along y and knee
        10.,
        5.,
        5.,
        1.,
...
CAMERA_TRANSFORM = [4.252296447753906, 4.261929988861084, 1.4334485530853271, 0.19544874131679535, 0.6209897398948669,
                    0.7103701829910278, 0.2674802839756012]
